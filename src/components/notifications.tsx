...
function NotificationsButton() {
    ...
    const handleNotificationsClick = () => {
        ...
        // For example, open a notifications panel or perform any other relevant action
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                {notificationCount > 0 && (
                    <span className="bg-blue-400 text-white rounded-full w-4 h-4 flex items-center justify-center absolute top-0 left-0 -mt-1 -mr-1">
                        {0}
                    </span>
                )}
            </button>
